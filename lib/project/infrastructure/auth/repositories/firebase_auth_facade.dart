...
import 'package:bonfire_adventures/common/utils/internet_connection.dart';
import 'package:bonfire_adventures/project/domain/auth/entities/user.dart';
import 'package:bonfire_adventures/project/domain/auth/interfaces/i_auth_facade.dart';
import 'package:bonfire_adventures/project/infrastructure/auth/mappers/firebase_user_mapper.dart';
import 'package:bonfire_adventures/project/infrastructure/auth/models/user_model.dart';
...
class FirebaseAuthFacade implements IAuthFacade {
  ...
  FirebaseAuthFacade(this._firebaseAuth, this._googleSignIn,
      this._firebaseUserMapper, this._firestore, this._facebookLogin);
  ...
  Future<Either<AuthFailure, User>> signInWithFacebook() async {
    ...
    switch (result.status) {
      case FacebookLoginStatus.loggedIn:
        ...
        User user = _firebaseUserMapper.toDomain(authResult.user);
